...
const materielNetParser = new MaterielNetParser(new Http());
const topAchatParser = new TopAchatParser(new Http());
const infomaxParser = new InfomaxParser(new Http());
